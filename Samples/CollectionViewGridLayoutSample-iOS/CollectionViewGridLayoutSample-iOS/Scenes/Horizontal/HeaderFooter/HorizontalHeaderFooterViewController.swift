//
//  HorizontalHeaderFooterViewController.swift
...
public class HorizontalHeaderFooterViewController: BaseViewController { }

extension HorizontalHeaderFooterViewController: CollectionViewDelegateHorizontalGridLayout {
    ...
    public func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, widthForFooterInSection section: Int) -> CGFloat {
        return 100
    }
...
extension HorizontalHeaderFooterViewController: UICollectionViewDataSource {
