# Contributing to framework-swift-template
...
* **Did the problem start happening recently** (e.g. after updating to a new version of framework-swift-template) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of framework-swift-template ?** What's the most recent version in which the problem doesn't happen? You can download older versions of framework-swift-template from [the releases page](https://github.com/digipolitan/framework-swift-template/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of framework-swift-template are you using?
...
#### Template For Submitting Bug Reports
    ...
    **framework-swift-template version:** [Enter framework-swift-template version here]
    ...
    * Problem started happening recently, didn't happen in an older version of framework-swift-template: [Yes/No]
